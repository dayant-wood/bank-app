...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    //after 5 min stop the timer and log out user
    if (time === 0) {
      clearInterval(timer);
...
console.log(currentAccount, timer);
...
// const calcDates = (day1, day2) => Math.abs(day2 - day1) / (1000 * 60 * 60 * 24);

// console.log(calcDates(new Date(2021, 5, 14), new Date(2020, 6, 16)));
...
//setTimeout
// const ingredients = ['broccoli', 'pineapple'];
// const timer = setTimeout(
//   (ing1, ing2) => console.log(`'Pizza Time' with ${ing1} ang ${ing2}`),
//   3000,
//   ...ingredients
// );

// if (ingredients.includes('broccoli')) clearTimeout(timer);
// console.log('waiting');
